...
public class Spearman extends Unit {
    public static final int CREATION_GOLD_COST = 20;
    public static final int SPEARMAN_HP = 20;
    public static final int SPEARMAN_MOVEMENT = 1;
    ...
    public Spearman(Player owner) {
        super(SPEARMAN_HP, SPEARMAN_MOVEMENT, SPEARMAN_ATTACK_POWER, SPEARMAN_ATTACK_RANGE, SPEARMAN_GOLD_COST, SPEARMAN_FOOD_COST, SPEARMAN_UNIT_SPACE, owner);
    }
