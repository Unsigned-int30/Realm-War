...
public class Swordman extends Unit {
    ...
    public static final int SWORDMAN_UNIT_SPACE = 1; // یا 2

    public Swordman(Player owner) {
        super(SWORDMAN_HP, SWORDMAN_MOVEMENT, SWORDMAN_ATTACK_POWER, SWORDMAN_ATTACK_RANGE,
                SWORDMAN_GOLD_COST, SWORDMAN_FOOD_COST, SWORDMAN_UNIT_SPACE, owner);
    }
